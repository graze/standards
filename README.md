...
2. The Object name is ordered naturally so that it is read from left to right (inverse of the DNS name).
3. By convention the namespace is assumed to be the standard TLD, exceptions MAY be made for thirdy party services.
4. Objects MUST be UpperCamelCase and acronyms MUST be Capitalised
